...
public class AppsMonitor extends Service {
	...
	public View addStatusBar() {
		statusBar = new TextView(this);
		statusBar.setText("Alaaaaaaaaaaaaa");
		final WindowManager.LayoutParams param = new WindowManager.LayoutParams();
		param.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE|WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN;
		param.type = WindowManager.LayoutParams.TYPE_SYSTEM_ALERT;
		param.width = LayoutParams.MATCH_PARENT;
		param.height = 200;
		param.gravity = Gravity.TOP | Gravity.FILL_HORIZONTAL;
		param.setTitle("StatusBar");
		final WindowManager wmgr = (WindowManager) getApplicationContext()
				.getSystemService(Context.WINDOW_SERVICE);
		wmgr.addView(statusBar, param);
		return view;
	}
